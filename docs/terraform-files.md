...
Folder: `/Users/chasejamieson/Documents/resume/azure-ops-ready-webapp/infra`
...
- `main.tf`: Also includes a precondition to ensure `location` is included in `allowed_locations` (fail fast if mismatched).
